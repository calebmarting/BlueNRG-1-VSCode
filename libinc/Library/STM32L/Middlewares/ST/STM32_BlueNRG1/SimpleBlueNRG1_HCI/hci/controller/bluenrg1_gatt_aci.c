                                      ...
                                      uint8_t Char_Value[])
{
  ...
  /* var_len_data input */
  {
    Osal_MemCpy((void *) &cp0->Char_Value, (const void *) Char_Value, Char_Value_Length*sizeof(uint8_t));
                                   ...
                                   uint8_t Char_Desc_Value[])
{
  ...
  /* var_len_data input */
  {
    Osal_MemCpy((void *) &cp0->Char_Desc_Value, (const void *) Char_Desc_Value, Char_Desc_Value_Length*sizeof(uint8_t));
    index_input += Char_Desc_Value_Length*sizeof(uint8_t);
  }
  Osal_MemSet(&rq, 0, sizeof(rq));
  rq.ogf = 0x3f;
