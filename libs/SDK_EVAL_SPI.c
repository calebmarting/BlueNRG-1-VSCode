...
#define SDK_EVAL_SPI_PERIPH_OUT_PIN        GPIO_Pin_2
#define SDK_EVAL_SPI_PERIPH_OUT_MODE       Serial0_Mode

#define SDK_EVAL_SPI_PERIPH_IN_PIN       GPIO_Pin_3
#define SDK_EVAL_SPI_PERIPH_IN_MODE       Serial0_Mode
